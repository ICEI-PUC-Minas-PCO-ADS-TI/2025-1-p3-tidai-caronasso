...
namespace caronasso.Migrations
{
    ...
    [Migration("20250530010908_addUserRating")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("caronasso.Models.AvaliacaoUsuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("caronasso.Models.AvaliacaoUsuario", b =>
                {
                    b.HasOne("caronasso.Models.Usuario", "UsuarioAvaliado")
                        .WithMany("AvaliacoesRecebidas")
                        .HasForeignKey("UsuarioAvaliadoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("caronasso.Models.Usuario", "UsuarioAvaliador")
